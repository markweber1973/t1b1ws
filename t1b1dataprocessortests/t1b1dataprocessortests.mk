...
$(IntermediateDirectory)/phasetest$(ObjectSuffix): phasetest.cpp $(IntermediateDirectory)/phasetest$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/mark/t1b1ws/t1b1dataprocessortests/phasetest.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/phasetest$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/phasetest$(DependSuffix): phasetest.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/phasetest$(ObjectSuffix) -MF$(IntermediateDirectory)/phasetest$(DependSuffix) -MM "phasetest.cpp"

$(IntermediateDirectory)/phasetest$(PreprocessSuffix): phasetest.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/phasetest$(PreprocessSuffix) "phasetest.cpp"
...
clean:
	...
	$(RM) $(IntermediateDirectory)/phasetest$(ObjectSuffix)
	$(RM) $(IntermediateDirectory)/phasetest$(DependSuffix)
	$(RM) $(IntermediateDirectory)/phasetest$(PreprocessSuffix)
	$(RM) $(OutputFile)
